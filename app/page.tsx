...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-background">
          ...
          <div className="grid items-center gap-12 lg:grid-cols-2">
            <div className="animate-fade-up space-y-6">
              ...
              <p className="max-w-lg text-lg text-muted-foreground text-balance">
                From moving and cleaning to construction and waste collection,
                AS-Teamet delivers reliable, high-quality work across Denmark.
              ...
              <div className="flex flex-wrap items-center gap-x-6 gap-y-2 pt-4 text-sm text-muted-foreground">
                ...
                <span className="flex items-center gap-1.5">
                  <CheckCircle2 className="h-4 w-4 text-primary" /> Fully
                  insured
                </span>
                <span className="flex items-center gap-1.5">
                  <CheckCircle2 className="h-4 w-4 text-primary" /> Same-day
                  available
                </span>
              </div>
            </div>
      ...
      <section
        id="services"
        className="container-px mx-auto max-w-7xl py-16 sm:py-24"
      >
        <div className="mb-12 text-center">
          ...
          <p className="mx-auto mt-3 max-w-2xl text-muted-foreground text-balance">
            We offer a full range of services to keep your home and business
            running smoothly. Whatever the job, we have a team for it.
          </p>
        </div>
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {services.map((service) => (
            <Card
              key={service.title}
              className="group overflow-hidden border-border/60 transition-all hover:shadow-lg hover:-translate-y-1 duration-300"
            >
          ...
          <div className="grid items-center gap-12 lg:grid-cols-2">
            <div className="space-y-5">
              ...
              <p className="text-muted-foreground text-balance">
                AS-Teamet was founded with a simple mission: to provide
                dependable, professional services that make life easier for our
                clients. Our trained teams handle every job with care,
                precision, and respect for your property.
              </p>
              <p className="text-muted-foreground text-balance">
                From a single moving job to ongoing cleaning contracts and
                construction projects, we bring the same level of commitment to
                every task. Based in Copenhagen, we serve clients across
                Denmark.
              </p>
              <div className="flex flex-col gap-3 sm:flex-row">
                <Button asChild>
